  ...
  return (
    <Root>
      ...
      <Content>
        ...
        <h3>Wii</h3>
        <p>Nintendo’s Wii is een pioneer voor de integratie van beweging in video games. De integratie van bewegingsdetectie op de 
          Wii hangt van twee dingen, de Wii-controller en de sensor bar. Net als de Kinect maakt de Wii gebruik van infrarode golven 
          ...
          controller zit een infrarood camera die het licht van de sensorbar kan lezen. De connectie tussen de Wii controller en de 
        ...
        <p>In de entertainment industrie wordt er gebruikt gemaakt van een bewegingsdetectie techniek genaamd motion capture. 
          Als je motion capture hoort, dan denk je vast aan mensen in gekke pakken met witte balletjes op hun gezicht. 
          Deze dingen zijn nodig voor motion capture. Bij motion capture volgt het systeem de beweging van de acteur, 
          zowel lichaam als gezicht, en zet het digitaal om in de computer in de vorm van een digitaal skelet. 
          Dit skelet wordt dan gebruikt voor de animatie voor een film of videogame. De resultaten kunnen altijd verschillen van succes, 
          maar het is effectieve methoden om materiaal te verkrijgen.[6]</p>
        <img style={{width:150, height:150}} src={pic6} /> <img style={{width:250, height:150}} src={pic7} />

        <h2>Hoe gebruiksvriendelijk is het?</h2>
        <p>Zoals er eerder is gezegd wordt bewegingswaarneming vaak gebruikt in entertainment. Van computerspellen tot tv’s, 
          gebruikers kunnen via beweging interacteren met hun digitale apparaten. </p>
        <p>Even terug naar de Wii. Het gebruik van de Wii is erg simpel. De sensor moet onder of boven de tv scherm zijn. 
          Met wat kalibratie kan de gebruiker de Wii controller op het tv scherm richten zodat er een cursor verschijnt en zo kan 
          interacteren met het scherm. De Wii controller werkt zo als een afstandsbediening, iets waarmee de meeste mensen bekend mee zijn. Ook kunnen gebruikers met de controller zwaaien voor interactie bij de meeste computerspellen.</p>
        <p>De Samsung Smart tv is een apparaat die ook goed gebruik maak van de bewegingsinteractie op een gebruiksvriendelijke manier. 
          Op de tv zelf zit een camera die de hand van de gebruiker herkent. Een open hand is nodig voor het navigeren op het scherm 
          terwijl een gesloten nodig is voor selecteren, twee gebaren die ieder mens kan maken, tenzij ze alle tien de vingers missen, 
        ...
        <p>Mensen bewegen, dat is normaal. Mensen moeten hun energie kwijt, of maken gebaren voor communicatie. Beweging is heel normaal. 
          Door het te integreren met apparatuur zoals tv’s zorgt ervoor dat mensen die minder verstand ervan hebben toch makkelijk gebruik 
          van maken.</p>
        <p>Zoals bijvoorbeeld de Samsung Smart tv. De smart tv geeft men de mogelijkheid om te navigeren zonder gebruik van de 
          afstandsbediening, en dus veel makkelijker en simpeler ermee gaan. Nu hoeven mensen niet meer druk te maken over vele knopjes.</p>
        <p>Uiteindelijk kunnen we deze technologie uitbreiden. Voor je het weet kunnen meerdere mensen een UI gebruiken zonder 
          een keyboard en/of muis te delen. Ook kunnen we voor meer interactie met onze entertainment zorgen.</p>
